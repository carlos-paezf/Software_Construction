...
const config: Config = {
    ...
    tagline: 'Aprende a construir software de calidad',
    ...
    projectName: 'Software_Construction', // Usually your repo name.
    ...
    themeConfig: {
        ...
        navbar: {
            title: 'Construcción de Software',
            logo: {
                alt: 'Software Construction Logo',
                src: 'img/logo.svg',
            },
            items: [
                {
        ...
        // Improve SEO
        metadata: [
            { name: 'keywords', content: 'software construction, academic, explanation, university, algorithms, computer science, javascript, typescript, documentation' },
